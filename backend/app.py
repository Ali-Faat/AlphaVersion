...
CORS(app, supports_credentials=True, resources={
    r"/api/*": {
        "origins": [
            ...
            "http://api.sportflyx.com:5000",
            "https://api.sportflyx.com:5000"
        ]
    },
    r"/validar_email": {
        "origins": [
...
def cadastro():
    try:
        ...
        # Link de verificação
        verification_link = f"https://api.sportflyx.com:5000/validar_email?token={verification_token}&apelido={apelido}"
        ...
        send_email(subject, email, body_text, body_html, sender="verficador.sportflyx@gmail.com")
...
def validar_email():
    ...
    try:
        ...
        if usuario:
            ...
            return redirect(f'https://sportflyx.com/pages/validar/validar.html?apelido={apelido}')
        else:
